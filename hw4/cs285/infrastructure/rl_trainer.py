...
from hw4.cs285.infrastructure.utils import sample_trajectories
...
class RL_Trainer(object):
    ...
    def collect_training_trajectories(self, itr, initial_expertdata,
                                      collect_policy, num_transitions_to_sample,
        ...
        """
        if itr == 0 and initial_expertdata:  # if first iteration, return expert data
            import pickle
        ...
        paths, envsteps_this_batch = sample_trajectories(self.env, collect_policy, num_transitions_to_sample, max_path_length)
